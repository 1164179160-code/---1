...
function AccessoriesGrid() {
  const accessories = [
    { name: '专业手套', desc: '防滑透气', price: '¥299', image: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?w=400&q=80' },
    { name: '运动手表', desc: 'GPS定位', price: '¥1,299', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&q=80' },
    { name: '骑行眼镜', desc: '防紫外线', price: '¥599', image: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400&q=80' },
    { name: '速干衣', desc: '排汗快干', price: '¥399', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&q=80' },
    { name: '安全头盔', desc: '轻量防护', price: '¥899', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80' },
    { name: '锁鞋', desc: '专业锁踏', price: '¥799', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80' },
  ];
    ...
    <TouchableOpacity style={styles.feedCardLarge} activeOpacity={0.9}>
      ...
      >
        <View style={styles.feedOverlay}>
          <View style={styles.feedTagLarge}>
